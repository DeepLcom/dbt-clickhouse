...
select 1 as id, {{ array_append(array_construct([1,2,3]), -77777777) }} as array_col union all
...
select 1 as id, {{ array_concat(array_construct([1,2,3]), array_construct([4,5,-77777777])) }} as array_col union all
